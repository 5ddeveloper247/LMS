...
Route::group(['prefix' => 'admin/payment', 'middleware' => ['auth', 'admin']], function () {
    ...
    Route::post('/saveTax', 'PaymentController@saveTax')->name('saveTax');
    ...
    Route::get('/online-payment-received-data', 'ReportController@onlineLogData')->name('onlineLogData')->middleware('RoutePermissionCheck:onlineLog');
