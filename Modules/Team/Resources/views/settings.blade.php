                        ...
                        <div class="white-box">
                            <div class="row p-0">
                                <div class="col-lg-12">
                                    ...
                                    <a href="{{route('auth.team')}}" class="primary-btn fix-gr-bg float-start " id="">
                                       
                                        {{'Generate Tokens'}}  </a>
                                    <h3 class="text-center">{{__('team.Setting')}}</h3>
                                    <hr>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <input
                                                    ...
                                                    value="@if(!empty($setting)) {{ old('api_key',$setting->team_api_key_of_user) }} @endif">
                                                <label>{{__('team.Api Key')}}<span>*</span> </label>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="input-effect sm2_mb_20 md_mb_20">
                                                <input
                                                    ...
                                                    value=" @if(!empty($setting)) {{ old('secret_key',$setting->team_api_serect_of_user) }} @endif">
                                                <label>{{__('team.Secret Key') }}<span>*</span></label>
                                                <span class="focus-border"></span>
