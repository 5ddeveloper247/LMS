...
@section('mainContent')
    ...
    <section class="admin-visitor-area up_st_admin_visitor">
        ...
        <div class="white_box mb_30 student-details header-menu">
            ...
            <form action="{{ route('savePackage') }}" method="POST" enctype="multipart/form-data" id="package_form"
                class="row">
                @csrf
                <div class="col-xl-12">
                    <div class="primary_input mb-25">
                        ...
                        <input type="text" name="title" id="title" placeholder="-"
                            class="primary_input_field mb-15" maxlength="50" value="{{ old('title') }}" required>
                    </div>
                </div>
                <div class="col-xl-4">
                    <div class="primary_input mb-25">
                        ...
                        <input type="text" name="price" id="price" placeholder="-"
                            class="primary_input_field mb-15" maxlength="30" value="{{ old('price') }}">
                    </div>
                </div>
                <div class="col-xl-4">
                    <div class="primary_input mb-25">
                        ...
                        <input type="number" name="allowed_courses" id="allowed_courses" placeholder="-"
                            class="primary_input_field mb-15" value="{{ old('allowed_courses') }}">
                    </div>
                </div>
                <div class="col-xl-4">
                    <div class="primary_input mb-25">
                ...
                <div class="col-xl-12">
                    <div class="primary_input mb-25">
                        ...
                        <input type="text" name="option_1" id="option_1" placeholder="-"
                            class="primary_input_field mb-15" maxlength="100" value="{{ old('option_1') }}" required>
                    </div>
                </div>
                <div class="col-xl-12">
                    <div class="primary_input mb-25">
                        ...
                        <input type="text" name="option_2" id="option_2" placeholder="-"
                            class="primary_input_field mb-15" maxlength="100" value="{{ old('option_2') }}" required>
                    </div>
                </div>
                <div class="col-xl-12">
                    <div class="primary_input mb-25">
                        ...
                        <input type="text" name="option_3" id="option_3" placeholder="-"
                            class="primary_input_field mb-15" maxlength="100" value="{{ old('option_3') }}" required>
                    </div>
                </div>
                <div class="col-xl-12">
                    <div class="primary_input mb-25">
                        ...
                        <input type="text" name="option_4" id="option_4" placeholder="-"
                            class="primary_input_field mb-15" maxlength="100" value="{{ old('option_4') }}" required>
                    </div>
                </div>
                <div class="col-xl-12">
                    <div class="primary_input mb-25">
                        ...
                        <input type="text" name="option_5" id="option_5" placeholder="-"
                            class="primary_input_field mb-15" maxlength="100" value="{{ old('option_5') }}" required>
                    </div>
                </div>
                <div class="col-xl-12">
                ...
                <div class="col-lg-12 pt_15 text-center">
                    <div class="d-flex justify-content-center">
                        <button type="submit" class="primary-btn semi_large2 fix-gr-bg"><i
                                class="ti-check"></i>{{ __('Add Package') }}
                        </button>
                    </div>
                </div>
            </form>
