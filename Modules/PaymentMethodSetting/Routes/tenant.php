...
Route::prefix('paymentmethodsetting')->middleware('auth')->group(function () {
    ...
    Route::get('authnet-data', 'PaymentMethodSettingController@fetchAuthorizenetData')->name('paymentmethodsetting.authnet_data')->middleware('RoutePermissionCheck:paymentmethodsetting.payment_method_setting');
