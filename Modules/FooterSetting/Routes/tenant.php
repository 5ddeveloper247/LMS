...
Route::prefix('footer')->as('footerSetting.')->middleware('auth')->group(function () {
    ...
    Route::post('footer-widget/changeOrder', 'FooterSettingController@changeFooterWidgetOrder')->name('footer.changeFooterWidgetOrder')->middleware('RoutePermissionCheck:footerSetting.footer.widget-update');;
