...
//cron
Route::get('class-remind',function(){
   Illuminate\Support\Facades\Artisan::call('view:clear');
});
Route::get('test-remind',function(){
  $user = Modules\Payment\Entities\StudentProgramPaymentPlans::where('id',329)->first();
  $shortcodes = array(
...
Route::get('register-declaration', 'Auth\RegisterController@RegisterDeclaration')->name('register.declaration');
...
Route::post('register-declaration', 'Auth\RegisterController@RegisterDeclarationCreate')->name('register.declarationp');
