...
$(document).on("click", "#saveplandata", function () {
    ...
    let amount = parseFloat($("#addAmount").val());
...
$(document).on("click", "#saveplandetail", function () {
    ...
    let total_amount = parseFloat($("#addAmount").val());
    let planed_amount = parseFloat($("#planed_amount").val());
    let pre_amount = parseFloat($("#planed_amount").val());
    ...
    let total_planed_amount = parseFloat(amount) + planed_amount;
    if (parseInt(id) > 0) {
