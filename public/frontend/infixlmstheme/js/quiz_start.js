    ...
    if (ans == "undefined" || ans == "" || ans == null) {
        ...
        if (question_type == "M") {
            ...
            if (
                ...
                $(".question_number_lists .link_" + assign_id)
                    .next(".nav-link")
                    .trigger("click");
                return true;
            }
        ...
        questionSubmitSingle(question_type, assign_id, courseType, program_id);
        $(".question_number_lists .link_" + assign_id)
            .next(".nav-link")
            .trigger("click");
    }
...
function questionSubmitSingle(question_type, assign_id) {
    ...
    let courseType = $('input[name="courseType"]').val();
...
$(document).on("change", ".quizAns", function () {
    let total = $(this)
        .closest(".singleQuestion")
        .find(".questionAnsTotal")
        .text();
    let checked = $(this)
        .closest(".singleQuestion")
        .find(".quizAns:checked").length;
    if (checked > total) {
