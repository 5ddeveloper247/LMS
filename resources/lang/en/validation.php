<?php return array(
    ...
    'phone.max' => 'The phone must be less then 15 characters.',
    'phone.unique' => 'The phone has already been taken.',
    'cell.required' => 'The cell field is required.',
    'cell.string' => 'The cell must be a string.',
    'cell.regex' => 'The cell format is invalid.',
    'cell.min' => 'The cell must be at least 11 characters.',
    'cell.max' => 'The cell must be less then 15 characters.',
    'cell.unique' => 'The cell has already been taken.',
    ...
    'Teach_phone.required' => 'The Teach Phone field is required',
    'employee_name.required' => 'The Employee Name field is required',
    'date_employer_start.required' => 'The Employer Start Date field is required',
    'date_employer_start.date' => 'The Employer Start Date field must be date',
    'date_employer_end.required_if' => 'The Employer End Date field is required',
    'date_employer_end.date' => 'The Employer End Date field must be date',
    'currently_employed.required' => 'The Currently Employed field must be true or false',
    'supervisor_name.required' => 'The Supervisor Name field is required',
    'employer_address.required' => 'The Employer Address field is required',
    'upload_resume.required' => 'The Upload Resume field is required',
    'cover_letter.required' => 'The Cover Letter field is required',
    ...
    'declaration_date.required' => 'The Declaration Date field is required',
    'declaration_date.after_or_equal' => 'The Declaration Date field must be equal and greater than today',
    ...
    'hours.min' => 'The Hours field min 1',
    'hours.max' => 'The Hours field max 24',
    'price.required' => 'The Price field is required',
    'facebook.url' => 'The facebook field must be url',
    'twitter.url' => 'The twitter field must be url',
    'linkedin.url' => 'The linkedin field must be url',
    'instagram.url' => 'The instagram field must be url',
    'youtube.url' => 'The youtube field must be url',
    'short_details.max' => 'The short description field must be less then 255',
