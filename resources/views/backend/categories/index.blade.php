                ...
                <div class="col-lg-3">
                    ...
                    <div class="white-box mb_30 student-details header-menu">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12 d-none mt-10">
                            ...
                            <div class="col-lg-12 d-none">
                                <div class="primary_input mb-15">
                                    <label class="primary_input_label" for="">{{ __('courses.Thumbnail Image') }}
                                    </label>
                                    <div class="primary_file_uploader">
                                        <input class="primary-input filePlaceholder" type="text" id=" "
                                            value="{{ isset($edit) ? $edit->thumbnail : '' }}" placeholder="Browse file"
                                            readonly="" {{ $errors->has('thumbnail') ? 'autofocus' : '' }}>
                                        <button class="" type="button">
                                            <label class="primary-btn small fix-gr-bg"
                                                for="document_file_2">{{ __('common.Browse') }}</label>
                                            <input type="file" class="d-none fileUpload" name="thumbnail"
                                                id="document_file_2">
                                        </button>
                                    </div>
                            ...
                            <div class="col-lg-12 text-center">
                                <div class="d-flex justify-content-center pt_20">
                                    <button type="submit" class="primary-btn semi_large fix-gr-bg" data-toggle="tooltip"
                                    ...
                                    <tbody>
                                        @foreach ($categories as $key => $category)
                                            <tr data-category-id="{{$category->id}}">
                                                ...
                                                <td>
                                                    @if (Str::length(@$category->description) > 30)
                                                ...
                                                <td class="nowrap">
                                                    <x-backend.status :id="$category->id" :status="$category->status" :route="'course.category.status_update'">
                                                    </x-backend.status>
...
@push('scripts')
	<script>
    var course_seq_url = '{{ route('changeCourseCategorySeq') }}';
	</script>
