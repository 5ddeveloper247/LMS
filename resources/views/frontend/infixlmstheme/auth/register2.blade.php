                ...
                <div class="mainform row py-5">
                    <div class="col-lg-8 order-lg-0 order-1">
                        <div id="second" class="form">
                            <h5 class="font-weight-bold text-center credit_card_auth">Bank Card Authorization Agreement
                            </h5>
                            ...
                            <div class="col-md-12 p-0">
                                <div class="row m-0">
                                    ...
                                    <div class="col-md-12 program mb-3">
                                        <span>hereby authorize Merkaii Xcellence Prep to charge my Credit or Debit
                                    ...
                                    <div class="col-md-6 program mb-4">
                                        <div class="borderbottom @if ($errors->first('declaration_date')) is-invalid @endif">
                                            <span class="custom_nowrap d-flex">Dated
                                                <input id="declaration_date" type="date" name="declaration_date"
                                                    class="border-0 float-right font-weight-normal   w-100"
                                    ...
                                    <div class="col-md-12 my-4">
                                        <div class="row">
                                            ...
                                            <div
                                                class="col-auto  @if ($errors->first('payment_type')) radiobox-invalid @endif">
                                                <div class="text my-2">
                                                    <span>
                                    ...
                                    <div class="col-md-6 text my-2">
                                        <div class="borderbottom @if ($errors->first('exp_date')) is-invalid @endif">
                                            <span class="d-flex nowrap">Expire Date: <input id="expire_date"
                                                    type="text" class="w-100 border-0" name="exp_date"
                                    ...
                                    <div class="col-md-12 text my-2">
                                        <div class="borderbottom  @if ($errors->first('card_appears_name')) is-invalid @endif">
                                            <span class="nowrap d-flex">Print Name as it appears on The Card:
                                                <input type="text" class="w-100 border-0" name="card_appears_name"
                                    ...
                                    <div class="col-md-6 text my-2">
                                        <div class="borderbottom @if ($errors->first('dollar_amount')) is-invalid @endif">
                                            <span class="d-flex nowrap">Amount (USD): <input type="text"
                                                    class="w-100 border-0" name="dollar_amount" value="100"
                                                    readonly></span>
                                    ...
                                    <div class="col-md-6 text my-2">
                                        <div class="borderbottom @if ($errors->first('stgnature')) is-invalid @endif">
                                            <span class="d-flex">Signature: <input type="text" class="w-100 border-0 "
                                                    name="stgnature"
                                    ...
                                    <div class="col-md-6 text my-2">
                                        <div class="borderbottom @if ($errors->first('paid_bill_date')) is-invalid @endif">
                                            <span class="d-flex">Date:<input id="paid_bill_date" type="date"
                                                    class="border-0 float-right font-weight-normal   w-100"
                                                    name="paid_bill_date"
                                    ...
                                    <div class="col-md-6 text my-2">
                                        <div class="borderbottom @if ($errors->first('paid_bill')) is-invalid @endif">
                                            <span class="d-flex nowrap">Paid bill: <input type="number"
                                                    class="w-100 border-0 " name="paid_bill"
                                    ...
                                    <div class="col-md-6 text my-2">
                                        <div class="borderbottom @if ($errors->first('student_signature_date')) is-invalid @endif">
                                            <span class="d-flex">Date:<input type="date"
                                                    class="border-0 float-right font-weight-normal   w-100"
