                ...
                <div class="col-xl-9 col-lg-9 col-md-8 col-12">
                    <div class="course_tabs">
                        ...
                        background: #eee;  " id="myTab" role="tablist">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link active tab_spy" id="Overview-tab" data-toggle="tab"
                                        onclick="fire(1)" role="tab" aria-controls="Overview"
                            ...
                            <div class="eventsIcon d-xl-none"><i id="right" class="fa-solid fa-angle-right"></i>
                            </div>
                        </div>
                    </div>
                    <hr>
                                        ...
                                        @if (isset($courses))
                                            @foreach ($courses as $course)
                                                <div class="card shadow-sm">
                                                    <div class="card-header custom_section_color d-flex justify-content-between p-4"
                                                    ...
                                                    <div id="collapse-{{ $course->id }}" class="controbtndo collapse"
                                                        ...
                                                        <div class="card-body border">
                                                            <div class="row">
                                                                <div
                                                                    class="col-lg-3 col-xl-3 col-md-6 col-sm-6 col-6 my-1">
                                        ...
                                        @if (isset($program_detail->programPlans) && count($program_detail->programPlans) > 0)
                                            @foreach ($program_detail->programPlans as $programPlans)
                                                <div class="card m-0 shadow-sm">
                                                    ...
                                                    <div id="collapse-{{ $programPlans->id }}"
                                                        class="controbtndo collapse" role="tabpanel"
                                            ...
                                            <div class="section__title">
                                                @if (count($limit_courses) == 0)
                                                    <h5 class="font-weight-bold mb-0">
                                                        {{ __('No more Prep-Course by Author') }}
                                                    </h5>
                                                @else
                                                    <h5 class="font-weight-bold mb-3">
                                                        {{ __('More Prep-Course by Author') }}
                                                    </h5>
                                                @endif
                                            </div>
                                            <div class="row">
