...
@section('mainContent')
    <div class="container-fluid">
        ...
        <div class="container custom-padd pb-0 px-md-5">
            <div class="row px-lg-4 ">
                ...
                <div class="col-6 col-md-4 d-flex justify-content-end">
                    ...
                    <a class="font-weight-500 pull-bs-canvas-left text-dark filter_btn" id="filter_btn" style="cursor: pointer">
                        Show Filter
        ...
        <div class="bs-canvas bs-canvas-left position-fixed bg-light h-100">
            <header class="border-bottom bs-canvas-header p-3">
                ...
                <button type="button" class="bs-canvas-close close" aria-label="Close"><span aria-hidden="true" class="">&times;</span></button>
            </header>
            <div class="bs-canvas-content px-3 py-1">
                ...
                <form action="{{ route('programs') }}" method="GET" class="form w-100" id="filter_form">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <label for="program_title">Program Title</label>
                            <input type="text" name="program_title" class="form-control form-control-sm" id="program_title"
                                   value="{{ request()->has('filter') ? request()->input('program_title','') : '' }}" placeholder="Enter Program Name">
                            <div id="program_list" class="position-absolute"></div>
                        </div>
                        ...
                        <div class="col-12 mt-3">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <div class="align-items-center d-flex flex-row-reverse gap-2">
                                    <p id="price_range_min"
                                       class="font-weight-bold">{{ request()->has('filter') ? request()->input('program_price_min',0) : 0 }}</p>
                                    <input type="range" min="0" max="{{ programFilterMaxPrice() }}" step="1"
                                           name="program_price_min"
                                           class="form-control accent-color p-0"
                                           oninput="price_range_min.innerText = this.value"
                                           id="program_price_min"
                                           value="{{ request()->has('filter') ? request()->input('program_price_min',0) : 0 }}">
                                </div>
    ...
    <script>
        ...
        $(document).ready(function () {
            ...
            $('#program_price_max,#program_price_min,#program_duration_min,#program_duration_max').on('change', function (event) {
                event.preventDefault();
