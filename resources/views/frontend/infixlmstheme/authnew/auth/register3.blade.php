                                ...
                                <div class="containerer program">
                                        ...
                                        <div id="first" class="col-md-12 form">
                                            @if(\App\Models\UserAuthorzIationAgreement::where('user_id', $user->id)->exists())
                                                <div class="alert alert-info shadow" role="alert">
                                                    <strong>Note !</strong> Your Authorization Form has already been uploaded as per request.
                                                </div>
                                            @else
                                    ...
                                    <div class="row d-none mt-3">
                                        ...
                                        <div class="col-md-12 d-flex justify-content-center mb-5 mt-3 gap-2">
                                            ...
                                            @else
                                                <a href="{{ asset('public/student_affidavit/agreement_form/Agreement_file.pdf') }}"
                                                   download="Agreement_file.pdf" id="redirect_to" class="theme_btn">Download
                                                    Form</a>
                                            @endif
                                        </div>
                            ...
                            <div class="remember_forgot_passs d-flex align-items-center">
                                <label class="primary_checkbox d-flex" for="checkbox">
                                    ...
                                    <p>{{ __('frontend.By signing up, you agree to') }} <a target="_blank"
                                        ...
                                        {{ __('frontend.and') }}
                                        <a target="_blank"
                                           href="{{ url('privacy') }}">{{ __('frontend.Privacy Policy') }}
                                            .</a>
                                    </p>
                                </label>
                            </div>
