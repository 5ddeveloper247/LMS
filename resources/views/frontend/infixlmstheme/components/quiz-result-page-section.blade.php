                        ...
                        <div class="col-12">
                            <div class="quiz_score_wrapper mb_30">
                                ...
                                <div class="quiz_test_body">
                                    <h3>{{ __('student.Congratulations! You’ve completed') }} {{ $course->quiz->title }}
                                    </h3>
                                    ...
                                    @if ($quiz->publish == 1)
                                                            ...
                                                            <ul>
                                                                <li class="mb_15">
                                                                    <label class="primary_checkbox2 d-flex">
                                                                        ...
                                                                        <span
                                                                            class="label_name">{{ $result['totalCorrect'] }}
                                                                            {{ __('student.Correct Answer') }}</span>
                                                                    </label>
                                                                </li>
                                                                <li>
                                                                    <label class="primary_checkbox2 error_ans d-flex">
                                                                        <input checked="" name="qus"
                                                                            type="checkbox" disabled>
                                                                        <span class="checkmark mr_10"></span>
                                                                        <span
                                                                            class="label_name">{{ $result['totalWrong'] }}
                                                        ...
                                                        <div class="single_score_view d-flex">
                                                            <div class="row">
                                                                ...
                                                                <div class="col md-2">
                                                                    ...
                                                                    <h4 class="f_w_700"> {{ $result['duration'] }}
                                                                    </h4>
                                                                </div>
                                        ...
                                        <div class="sumit_skip_btns d-flex align-items-center">
                                            <a href="{{ courseDetailsUrl(@$course->id, @$course->type, @$course->slug) . '?courseType=' . $course->type }}"
