                ...
                <div class="container-fluid">
                    <div class="row justify-content-center">
                        @if (permissionCheck('dashboard.monthly_income'))
                            <div class="col-lg-6">
                                <div class="white_box chart_box mt_30">
                                    <h4>{{ __('Monthly Income Stats for') }} {{ date('Y') }}</h4>
                                    <div class="">
                        ...
                        @if (permissionCheck('dashboard.payment_statistic'))
                            <div class="col-lg-6">
                                <div class="white_box chart_box mt_30">
                                    <h4>{{ __('dashboard.Payment Statistics for') }}
                ...
                <div class="white_box chart_box mt_30">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-3 mb-3">
                            <input type="radio" checked class="common-radio userLoginChartByDays"
                                id="userLoginChartByDays7" name="userLoginChartByDays" value="7">
                            <label for="userLoginChartByDays7">{{ __('dashboard.Last 7 Days') }}</label>
                        </div>
                        <div class="col-md-3 mb-3">
                            <input type="radio" class="common-radio userLoginChartByDays" id="userLoginChartByDays14"
                                name="userLoginChartByDays" value="14">
                            <label for="userLoginChartByDays14">{{ __('dashboard.Last 14 Days') }}</label>
                        </div>

                        <div class="col-md-3 mb-3">
                            <input type="radio" class="common-radio userLoginChartByDays" id="userLoginChartByDays30"
                                name="userLoginChartByDays" value="30">
                            <label for="userLoginChartByDays30">{{ __('dashboard.Last 30 Days') }}</label>
                        </div>


                        <div class="col-md-3 mb-3">
                            <input type="radio" class="common-radio" id="userLoginChartByDaysCustom"
                                name="userLoginChartByDays" value="custom">
                            <label for="userLoginChartByDaysCustom">{{ __('dashboard.Others') }}</label>
        ...
        @if (permissionCheck('userLoginChartByTime'))
            <div class="col-lg-12">
                <div class="white_box chart_box mt_30">
                    ...
                    <div class="row justify-content-center">
                        <div class="col-md-3 mb-3">
                            <input type="radio" checked class="common-radio userLoginChartByTime"
                                id="userLoginChartByTime7" name="userLoginChartByTime" value="7">
                            <label for="userLoginChartByTime7">{{ __('dashboard.Last 7 Days') }}</label>
                        </div>
                        <div class="col-md-3 mb-3">
                            <input type="radio" class="common-radio userLoginChartByTime" id="userLoginChartByTime14"
                                name="userLoginChartByTime" value="14">
                            <label for="userLoginChartByTime14">{{ __('dashboard.Last 14 Days') }}</label>
                        </div>

                        <div class="col-md-3 mb-3">
                            <input type="radio" class="common-radio userLoginChartByTime" id="userLoginChartByTime30"
                                name="userLoginChartByTime" value="30">
                            <label for="userLoginChartByTime30">{{ __('dashboard.Last 30 Days') }}</label>
                        </div>


                        <div class="col-md-3 mb-3">
                            <input type="radio" class="common-radio" id="userLoginChartByTimeCustom"
                                name="userLoginChartByTime" value="custom">
                            <label for="userLoginChartByTimeCustom">{{ __('dashboard.Others') }}</label>
    ...
    <script>
        ...
        @if (permissionCheck('dashboard.overview_of_courses'))
            ...
            var myChart = new Chart(ctx, {
                type: 'doughnut',
                data: {
                    labels: ['{{ __('dashboard.Courses') }}', '{{ __('dashboard.Quizzes') }}',
                        '{{ __('dashboard.Classes') }}', '{{ __('Program') }}'
                    ],
                    datasets: [{
                        label: '{{ __('Overview of Topics') }}',
                        data: [{{ $course_overview['courses'] }}, {{ $course_overview['quizzes'] }},
                            {{ $course_overview['classes'] }}, {{ $course_overview['programs'] }}
                        ],
                        backgroundColor: [
                            'rgba(255, 99, 132, 0.2)',
                            'rgba(54, 162, 235, 0.2)',
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    datasets: [{
                        ...
                        data: [{{ $payment_statistics['paid']->count() }},
                            {{ $payment_statistics['unpaid']->count() }}
                        ],
        ...
        @if (permissionCheck('dashboard.monthly_income'))
            ...
            var myChart = new Chart(ctx, {
                ...
                data: {
                    ...
                    labels: month_name,
                    datasets: [{
                        label: '{{ __('Monthly Income Stats for ') }} {{ @$payment_statistics['month'] }}' +
