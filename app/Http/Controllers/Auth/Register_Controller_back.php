...
class RegisterController extends Controller
{
    ...
    */
    ...
    public function RegisterForm()
    {
        ...
        return view(theme('auth.register'), get_defined_vars());
    }
    ...
    public function RegisterForm2()
    {
        ...
        return view(theme('auth.register2'), compact('page', 'user', 'userSetting', 'payment_details'));
    }
    ...
    public function RegisterForm3()
    {
        ...
        return view(theme('auth.register3'), compact('page', 'user', 'userSetting', 'payment_details'));
    }
    ...
    public function RegisterDeclaration(){
      ...
      $page = LoginPage::getData();
      return view(theme('auth.register-declaration'), compact('user','page','userSetting','userDeclaration'));
    }
    ...
    public function RegisterFormPay()
    {
        ...
        try {
            ...
            $page = LoginPage::getData();
            // dd(get_defined_vars());
            return view(theme('auth.register-pay'), get_defined_vars());
        } catch (\Exception $e) {
          //  dd("c");
    ...
    public function RegisterDeclarationCreate(Request $request){
      ...
      $userDeclaration->student_signature = $request->input('student_signature');
    ...
    public function RegisterFormPayCreate(Request $request)
    {
        ...
        try {
            ...
            $paymentResponse = $clover->makePayment($request, 'student_register', true, null, true); //previous code has the last parameter true
